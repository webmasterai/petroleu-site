...
export const websiteContent = {
  ...
  pricing: {
    monthly: [
      ...
      },
      {
        name: 'Enterprise',
        price: 'Custom',
        description: 'For large fuel networks',
        features: [
          'Unlimited Stations',
  ...
  industries: [
    ...
    },
    {
      ...
      description: 'Factories and construction sites with bulk fuel storage',
  ...
  gettingStarted: [
    ...
    },
    {
      ...
      title: 'Setup Station',
      description:
        'Add your pumps, nozzles, tanks, employees, and credit customers with our guided wizard.',
    },
    {
      number: '03',
      icon: 'Rocket',
      title: 'Go Live',
      description:
        'Start recording readings, tracking fuel stock, and managing your station from day one.',
    },
  ],
